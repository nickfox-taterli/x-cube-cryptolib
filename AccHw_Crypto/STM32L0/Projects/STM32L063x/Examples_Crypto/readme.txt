...
1. AES:
   ...
   - AES128 CMAC Encryption/Decryption       (for more details about this example pleaser refer to aes_128bits_cmac.txt)
   - AES128 GCM Encryption/Decryption        (for more details about this example pleaser refer to aes_128bits_gcm.txt)
...
Note: Due to Heap and stack size limitation, only one example should uncomment in main.h file.
Heap and stack size required for each exmpale are provided in user manual UM1924 availiable at www.st.com  


@par Directory contents 

  - Examples_Crypto/Inc/STM32l0xx_hal_conf.h                 HAL configuration file        
  - Examples_Crypto/Inc/STM32l0xx_it.h                       Interrupt handlers header file
  ...
  - Examples_Crypto/Src/STM32l0xx_it.c                       Interrupt handlers
  ...
  - Examples_Crypto/Src/system_stm32l0xx.c                   STM32l0xx system source file


@par Hardware and Software environment  

  - This example runs on STM32L063R8 device
    
  - This example has been tested with STM32L063-Nucleo RevC  board and can be
