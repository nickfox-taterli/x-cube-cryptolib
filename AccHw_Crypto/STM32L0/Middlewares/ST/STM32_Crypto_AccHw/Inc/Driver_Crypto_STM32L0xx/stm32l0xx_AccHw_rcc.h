...
#ifndef __AccHw_STM32L0XX_RCC_H
#define __AccHw_STM32L0XX_RCC_H
...
#define AccHw_RCC_AHBPeriph_AES                 AccHw_RCC_AHBENR_CRYPEN
#define AccHw_RCC_AHBPeriph_RNG                 AccHw_RCC_AHBENR_RNGEN
