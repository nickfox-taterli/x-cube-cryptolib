...
5. Random Bytes Generation                   (for more details about this example pleaser refer to rand_bytes_gen.txt)
...
@par Directory contents 
  ...
  - Examples_Crypto/Inc/STM32l1xx_hal_conf.h                 HAL configuration file        
  - Examples_Crypto/Inc/STM32l1xx_it.h                       Interrupt handlers header file
  ...
  - Examples_Crypto/Src/STM32l1xx_it.c                       Interrupt handlers
  ...
  - Examples_Crypto/Src/system_stm32l1xx.c                   STM32l1xx system source file


@par Hardware and Software environment  

  - This example runs on STM32L162VE device
    
  - This example has been tested with STM32L162_EVAL RevB board and can be
