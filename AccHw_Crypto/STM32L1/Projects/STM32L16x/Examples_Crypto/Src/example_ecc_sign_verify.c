...
static int32_t STM32_SHA256_HASH_DigestCompute_ECCSignVerif(uint8_t* InputMessage,
...
int ExampleECCSignVerif(void)
{
  ...
  for (param_ecc_counter = 0; param_ecc_counter < 3; param_ecc_counter++)
  {
    ...
    status = STM32_SHA256_HASH_DigestCompute_ECCSignVerif((uint8_t*)InputMessage,
             InputLength,
             (uint8_t*)MessageDigest,
        ...
        if (status == ECC_SUCCESS)
        {
          ...
          if (status == ECC_SUCCESS)
          {
            ...
            if (status == ECC_SUCCESS)
            {
              ...
              /* Verify it */
              status = AccHw_ECDSAverify(MessageDigest, MessageDigestLength, sign, &verctx, &Crypto_Buffer);
...
/**
  ...
  */
static int32_t STM32_SHA256_HASH_DigestCompute_ECCSignVerif(uint8_t* InputMessage, uint32_t InputMessageLength,
