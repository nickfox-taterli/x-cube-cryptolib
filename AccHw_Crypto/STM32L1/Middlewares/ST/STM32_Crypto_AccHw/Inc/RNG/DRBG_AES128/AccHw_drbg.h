...
#ifndef __CRL_AccHw_DRGB_H__
#define __CRL_AccHw_DRGB_H__
...
int32_t AccHw_crl_DRBG_AES128_Instantiate(uint8_t *P_pState,
...
int32_t AccHw_crl_DRBG_AES128_Generate(uint8_t *P_pState,
                             uint8_t *P_pOutput,
                             const uint8_t *P_pAddInput,
                             int32_t P_addInputSize,
                             int32_t P_nBytes);
/* Reseed *********************************************************************/
int32_t AccHw_crl_DRBG_AES128_Reseed(uint8_t *P_pState,
                           const uint8_t *P_pEntropyInput,
                           int32_t P_entropySize,
                           const uint8_t *P_pAddInput,
                           int32_t P_addInputSize);
