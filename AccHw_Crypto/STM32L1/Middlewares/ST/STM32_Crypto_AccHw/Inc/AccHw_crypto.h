...
#include "Driver_Crypto_STM32L1xx/stm32l1xx_AccHw.h"
...
#if defined(INCLUDE_CTR) && !defined(INCLUDE_AccHw_AES)
...
#if defined(INCLUDE_DRBG_AES128) && !defined(INCLUDE_AccHw_AES128)
#error "DRBG_AES128 requires INCLUDE_AccHw_AES_128"
#endif
...
#if defined(INCLUDE_AccHw_ECC_SIGN) & !(defined(INCLUDE_DRBG_AES128))                 ////TBC
