...
#ifndef __AccHw_STM32L4XX_AES_H
#define __AccHw_STM32L4XX_AES_H
...
typedef struct
{
  ...
  uint32_t AES_Key4;  /*!< Key[31:0]   */
  uint32_t AES_Key5;  /*!< Key[63:32]  */
  uint32_t AES_Key6;  /*!< Key[95:64]  */
  uint32_t AES_Key7;  /*!< Key[127:96] */
