/**
  ******************************************************************************
  * @file    Examples_Crypto/Src/example_ecc_sign_verify.c
  * @author  MCD Application Team
  * @version V3.1.0
  * @date    30-October-2015
  * @brief   ECC Signature and Verification Example
  ******************************************************************************
  * @attention
  *
...
/******************************************************************************/
/* Private variables ---------------------------------------------------------*/
const uint8_t InputMessage_192_ECCSignVerif[] =
  {
...
const uint8_t P_192_a_ECCSignVerif[] =
  {
...
/* coefficient b */
const uint8_t P_192_b_ECCSignVerif[] =
  {
...
/* prime modulus p*/
const uint8_t P_192_p_ECCSignVerif[] =
  {
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
...
/* order n*/
const uint8_t P_192_n_ECCSignVerif[] =
  {
...
/* base point Gx*/
const uint8_t P_192_Gx_ECCSignVerif[] =
  {
...
/* base point Gy*/
const uint8_t P_192_Gy_ECCSignVerif[] =
  {
...
/* ECSA public key */
/* pub_x*/
const uint8_t pub_x_192_ECCSignVerif[] =
  {
...
/* pub_y */
const uint8_t pub_y_192_ECCSignVerif[] =
  {
...
/* sign_r */
const uint8_t sign_r_192_ECCSignVerif[] =
  {
...
/* sign_s */
const uint8_t sign_s_192_ECCSignVerif[] =
  {
...
/******************************************************************************/
/* Private variables ---------------------------------------------------------*/
const uint8_t InputMessage_256_ECCSignVerif[] =
  {
...
const uint8_t P_256_a_ECCSignVerif[] =
  {
...
/* coefficient b */
const uint8_t P_256_b_ECCSignVerif[] =
  {
...
/* prime modulus p*/
const uint8_t P_256_p_ECCSignVerif[] =
  {
    0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
...
/* order n*/
const uint8_t P_256_n_ECCSignVerif[] =
  {
...
/* base point Gx*/
const uint8_t P_256_Gx_ECCSignVerif[] =
  {
...
/* base point Gy*/
const uint8_t P_256_Gy_ECCSignVerif[] =
  {
...
/* ECSA public key */
/* pub_x */
const uint8_t pub_x_256_ECCSignVerif[] =
  {
...
/* pub_y */
const uint8_t pub_y_256_ECCSignVerif[] =
  {
...
/* ECDSA signature of SHA-256("....") */
/* sign_r */
const uint8_t sign_r_256_ECCSignVerif[] =
  {
...
/* sign_s */
const uint8_t sign_s_256_ECCSignVerif[] =
  {
...
/******************************************************************************/
/* Private variables ---------------------------------------------------------*/
const uint8_t InputMessage_384_ECCSignVerif[] =
  {
...
const uint8_t P_384_a_ECCSignVerif[] =
  {
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
...
/* coefficient b */
const uint8_t P_384_b_ECCSignVerif[] =
  {
...
/* prime modulus p*/
const uint8_t P_384_p_ECCSignVerif[] =
  {
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00,
...
/* order n*/
const uint8_t P_384_n_ECCSignVerif[] =
  {
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
...
/* base point Gx*/
const uint8_t P_384_Gx_ECCSignVerif[] =
  {
...
/* base point Gy*/
const uint8_t P_384_Gy_ECCSignVerif[] =
  {
...
/* ECSA public key */
/* pub_x */
const uint8_t pub_x_384_ECCSignVerif[] =
  {
...
/* pub_y */
const uint8_t pub_y_384_ECCSignVerif[] =
  {
...
/* ECDSA signature of SHA-256("....") */
/* sign_r */
const uint8_t sign_r_384_ECCSignVerif[] =
  {
...
/* sign_s */
const uint8_t sign_s_384_ECCSignVerif[] =
  {
  ...
  for (param_ecc_counter = 0; param_ecc_counter < 3; param_ecc_counter++)
  {
    switch (param_ecc_counter)
    {
      case 0:
        ...
        EC_st.pmA = P_192_a_ECCSignVerif;
        EC_st.pmB = P_192_b_ECCSignVerif;
        EC_st.pmP = P_192_p_ECCSignVerif;
        EC_st.pmN = P_192_n_ECCSignVerif;
        EC_st.pmGx = P_192_Gx_ECCSignVerif;
        EC_st.pmGy = P_192_Gy_ECCSignVerif;
        EC_st.mAsize = sizeof(P_192_a_ECCSignVerif);
        EC_st.mBsize = sizeof(P_192_b_ECCSignVerif);
        EC_st.mNsize = sizeof(P_192_n_ECCSignVerif);
        EC_st.mPsize = sizeof(P_192_p_ECCSignVerif);
        EC_st.mGxsize = sizeof(P_192_Gx_ECCSignVerif);
        EC_st.mGysize = sizeof(P_192_Gy_ECCSignVerif);
        pub_x = pub_x_192_ECCSignVerif;
        pub_y = pub_y_192_ECCSignVerif;
        sign_r = sign_r_192_ECCSignVerif;
        sign_s = sign_s_192_ECCSignVerif;
        InputMessage =  InputMessage_192_ECCSignVerif;
        pub_x_size = sizeof(pub_x_192_ECCSignVerif);
        pub_y_size = sizeof(pub_y_192_ECCSignVerif);
        sign_r_size = sizeof(sign_r_192_ECCSignVerif);
        sign_s_size = sizeof(sign_s_192_ECCSignVerif);
        InputLength = sizeof(InputMessage_192_ECCSignVerif);
        break;

      case 1:
        /* Initialize the ECC curve structure, with all the parameters */
        EC_st.pmA = P_256_a_ECCSignVerif;
        EC_st.pmB = P_256_b_ECCSignVerif;
        EC_st.pmP = P_256_p_ECCSignVerif;
        EC_st.pmN = P_256_n_ECCSignVerif;
        EC_st.pmGx = P_256_Gx_ECCSignVerif;
        EC_st.pmGy = P_256_Gy_ECCSignVerif;
        EC_st.mAsize = sizeof(P_256_a_ECCSignVerif);
        EC_st.mBsize = sizeof(P_256_b_ECCSignVerif);
        EC_st.mNsize = sizeof(P_256_n_ECCSignVerif);
        EC_st.mPsize = sizeof(P_256_p_ECCSignVerif);
        EC_st.mGxsize = sizeof(P_256_Gx_ECCSignVerif);
        EC_st.mGysize = sizeof(P_256_Gy_ECCSignVerif);
        pub_x = pub_x_256_ECCSignVerif;
        pub_y = pub_y_256_ECCSignVerif;
        sign_r = sign_r_256_ECCSignVerif;
        sign_s = sign_s_256_ECCSignVerif;
        InputMessage =  InputMessage_256_ECCSignVerif;
        pub_x_size = sizeof(pub_x_256_ECCSignVerif);
        pub_y_size = sizeof(pub_y_256_ECCSignVerif);
        sign_r_size = sizeof(sign_r_256_ECCSignVerif);
        sign_s_size = sizeof(sign_s_256_ECCSignVerif);
        InputLength = sizeof(InputMessage_256_ECCSignVerif);
        break;

      case 2:
        /* Initialize the ECC curve structure, with all the parameters */
        EC_st.pmA = P_384_a_ECCSignVerif;
        EC_st.pmB = P_384_b_ECCSignVerif;
        EC_st.pmP = P_384_p_ECCSignVerif;
        EC_st.pmN = P_384_n_ECCSignVerif;
        EC_st.pmGx = P_384_Gx_ECCSignVerif;
        EC_st.pmGy = P_384_Gy_ECCSignVerif;
        EC_st.mAsize = sizeof(P_384_a_ECCSignVerif);
        EC_st.mBsize = sizeof(P_384_b_ECCSignVerif);
        EC_st.mNsize = sizeof(P_384_n_ECCSignVerif);
        EC_st.mPsize = sizeof(P_384_p_ECCSignVerif);
        EC_st.mGxsize = sizeof(P_384_Gx_ECCSignVerif);
        EC_st.mGysize = sizeof(P_384_Gy_ECCSignVerif);
        pub_x = pub_x_384_ECCSignVerif;
        pub_y = pub_y_384_ECCSignVerif;
        sign_r = sign_r_384_ECCSignVerif;
        sign_s = sign_s_384_ECCSignVerif;
        InputMessage =  InputMessage_384_ECCSignVerif;
        pub_x_size = sizeof(pub_x_384_ECCSignVerif);
        pub_y_size = sizeof(pub_y_384_ECCSignVerif);
        sign_r_size = sizeof(sign_r_384_ECCSignVerif);
        sign_s_size = sizeof(sign_s_384_ECCSignVerif);
        InputLength = sizeof(InputMessage_384_ECCSignVerif);
        break;
...

    {
      ...
      if (status == ECC_SUCCESS)
      {
        ...
        if (status == ECC_SUCCESS)
        {
          ...
          AccHw_ECCsetPointCoordinate(PubKey, AccHw_E_ECC_POINT_COORDINATE_X, pub_x, pub_x_size);
          AccHw_ECCsetPointCoordinate(PubKey, AccHw_E_ECC_POINT_COORDINATE_Y, pub_y, pub_y_size);

          /* Try to validate the Public Key. */
          status = AccHw_ECCvalidatePubKey(PubKey, &EC_st, &Crypto_Buffer);
          if (status == ECC_SUCCESS)
          {
            ...
            if (status == ECC_SUCCESS)
            {
              ...
              AccHw_ECDSAsetSignature(sign, AccHw_E_ECDSA_SIGNATURE_R_VALUE, sign_r, sign_r_size);
              AccHw_ECDSAsetSignature(sign, AccHw_E_ECDSA_SIGNATURE_S_VALUE, sign_s, sign_s_size);
