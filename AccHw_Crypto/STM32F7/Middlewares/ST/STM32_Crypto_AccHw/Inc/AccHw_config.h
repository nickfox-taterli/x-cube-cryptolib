...
#define INCLUDE_AccHw_POLY1305  ((uint16_t)0x0001) /*!< This defines if Poly1305-AES functions are included in the library */
  ...
  */
  ...
  /**
    ...
    */
  /* #define AccHw_CRL_AES_ALGORITHM 1 */  /*!< version with 522 bytes of look-up tables is selected */
#define AccHw_CRL_AES_ALGORITHM 2     /*!< version with 2048 bytes of look-up tables is selected */
  /**
    * @}   End of AESConf
    */
  ...
  /**
    ...
    * @{
    */
  /* #define AccHw_RSA_WINDOW_SIZE 1 */   /*!< Window size selected is 1 */
  /* #define AccHw_RSA_WINDOW_SIZE 2 */   /*!< Window size selected is 2 */
  /* #define AccHw_RSA_WINDOW_SIZE 3 */   /*!< Window size selected is 3 */
#define AccHw_RSA_WINDOW_SIZE 4   /*!< Window size selected is 4 */
  /**
    * @}  End of RSAConf
    */
  ...
  /**
    ...
    * @{
    */
#define AccHw_CRL_GFMUL 0   /*!< Any tables is selected */
  /* #define AccHw_CRL_GFMUL 1 */   /*!< Key-dependent table  is selected   */
  /* #define AccHw_CRL_GFMUL 2 */    /*!< 4 key-dependent tables is selected */
  /**
    * @}  End of GCMConf
    */
