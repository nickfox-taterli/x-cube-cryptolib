/**
  @page AES  AES128_OFB Example
  
  @verbatim
  ******************** (C) COPYRIGHT 2015 STMicroelectronics *******************
  * @file    AES128_OFB/readme.txt 
  * @author  MCD Application Team
  * @version V3.1.0
  * @date    30-October-2015
  * @brief   Description of the "AES128 in OFB mode" example.
  ******************************************************************************
  * @attention
  *
...
128 bits Encryption/Decryption processes for OFB mode .

This example is split into two parts:
The first part is to:
1 - Encrypt DATA in OFB mode 
...
@note NIST vectors examples for AES OFB are taken from:
...
@par Directory contents 
  ...
  - AES/AES128_OFB/Inc/STM32f2xx_hal_conf.h    HAL configuration file
  - AES/AES128_OFB/Inc/STM32f2xx_it.h          Interrupt handlers header file
  - AES/AES128_OFB/Inc/main.h                  Header for main.c module  
  - AES/AES128_OFB/Src/STM32f2xx_it.c          Interrupt handlers
  - AES/AES128_OFB/Src/main.c                  Main program
  - AES/AES128_OFB/Src/system_stm32f2xx.c      STM32F2xx system source file
