...
const uint8_t IV[CRL_CHACHA_NONCE] = { 0x0f, 0x1e, 0x2d, 0x3c, 0x4b, 0x5a, 0x69, 0x78 };
...
int main(void)
{
 ...
 __CRC_CLK_ENABLE();
  ...
  status = STM32_CHACHA_20_Encrypt( (uint8_t *) Plaintext, PLAINTEXT_LENGTH, Key, IV, sizeof(IV), OutputMessage,
                            &OutputMessageLength);
