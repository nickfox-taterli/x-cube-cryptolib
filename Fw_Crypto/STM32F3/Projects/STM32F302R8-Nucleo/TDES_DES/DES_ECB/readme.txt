/**
  @page DES_ECB  TDES algorithm in ECB mode

  @verbatim
  ******************** (C) COPYRIGHT 2015 STMicroelectronics *******************
  * @file    TDES_DES/DES_ECB/readme.txt 
  * @author  MCD Application Team
  * @version V3.1.0
  * @date    30-October-2015
  * @brief   Description of the "DES ECB modes" example.
  ******************************************************************************
  *
...
@note NIST vectors examples for DES ECB are taken from:
...
@par Directory contents 
  ...
  - TDES_DES/DES_ECB/Inc/STM32f3xx_hal_conf.h    HAL configuration file
  - TDES_DES/DES_ECB/Inc/STM32f3xx_it.h          Interrupt handlers header file
  - TDES_DES/DES_ECB/Inc/main.h                  Header for main.c module  
  - TDES_DES/DES_ECB/Src/STM32f3xx_it.c          Interrupt handlers
  - TDES_DES/DES_ECB/Src/main.c                  Main program
  - TDES_DES/DES_ECB/Src/system_stm32f3xx.c      STM32F3xx system source file
